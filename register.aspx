...
<img id="logo" src="icons/logo.png" height="70px" class="rounded-circle" /></a>
  ...
  <div class="input_container">
    ...
    <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
      ...
      <asp:TextBox ID="reg_username" runat="server" placeholder="username" title="Inpit title" name="input-name" type="text" class="input_field" ></asp:TextBox>
  </div>
   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Username required" ControlToValidate="reg_username" Font-Size="12px" ForeColor="Red"></asp:RequiredFieldValidator>
   <div class="input_container">
    ...
    <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
      ...
      <asp:TextBox ID="reg_email" runat="server" placeholder="name@mail.com" title="Inpit title" name="input-name" type="text" class="input_field" ></asp:TextBox>
   
  </div>
   <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Email required" ControlToValidate="reg_email" Font-Size="12px" ForeColor="Red"></asp:RequiredFieldValidator>
   <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="reg_email"
  ...
  <div class="input_container">
    ...
    <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
      ...
      <asp:TextBox ID="reg_pass" runat="server" placeholder="Password" title="Inpit title" name="input-name" type="password" class="input_field" ></asp:TextBox>
   
  </div>
   <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Password required" ControlToValidate="reg_pass" Font-Size="12px" ForeColor="Red"></asp:RequiredFieldValidator>
    <asp:Button ID="reg_btn" runat="server" Text="Register" title="Sign In" class="sign-in_btn" onclick="reg_btn_Click" />
  ...
  <div class="separator">
    ...
    <asp:Button ID="signin_btn" runat="server" Text="Sign In"  type="submit" class="sign-in_ggl" OnClientClick="login.aspx" />
  <a href="tc.aspx"><p class="note">Terms of use &amp; Conditions</p></a>
</div>
</center>
<br />
<br />        
